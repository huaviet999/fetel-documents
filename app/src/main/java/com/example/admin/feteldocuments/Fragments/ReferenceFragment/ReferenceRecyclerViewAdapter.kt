...
class ReferenceRecyclerViewAdapter(val context: Context?, val dataList : ArrayList<ContentModel>) : RecyclerView.Adapter<ReferenceRecyclerViewAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(p0: ViewHolder, p1: Int) {
        p0.referenceName.text = dataList[p1].getContentName()
    ...
    inner class ViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView){
        var referenceName = itemView.lecture_name
    }
}